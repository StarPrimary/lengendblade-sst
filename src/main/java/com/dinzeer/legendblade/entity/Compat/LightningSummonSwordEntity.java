...
public class LightningSummonSwordEntity extends EntityAbstractSummonedSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(LightningSummonSwordEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(LightningSummonSwordEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(LightningSummonSwordEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public LightningSummonSwordEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static LightningSummonSwordEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new LightningSummonSwordEntity(LBEntiteRegristrys.ss, worldIn);
    }

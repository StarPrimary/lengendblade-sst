...
public class HosSummonSwordEntity extends EntityAbstractSummonedSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(HosSummonSwordEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(HosSummonSwordEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(HosSummonSwordEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public HosSummonSwordEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static HosSummonSwordEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new HosSummonSwordEntity(L2LBcompatRegsitry.HSS, worldIn);
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (!level.isClientSide()) {
            if (entity instanceof LivingEntity livingEntity) {
                ...
                livingEntity.addEffect(new MobEffectInstance(LCEffects.CURSE.get(), 300, 2));
}

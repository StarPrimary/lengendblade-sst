...
public class SumonSwordEntity extends EntityAbstractSummonedSword {
    ...
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(SumonSwordEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public SumonSwordEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static SumonSwordEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new SumonSwordEntity(LBEntiteRegristrys.ss, worldIn);
    }

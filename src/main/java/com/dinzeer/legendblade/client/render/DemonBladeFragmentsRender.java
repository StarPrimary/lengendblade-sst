...
@OnlyIn(Dist.CLIENT)
public class DemonBladeFragmentsRender<T extends EntityAbstractSummonedSword> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = ResourceLocation.tryParse("model/util/ss.png");
    private static final ResourceLocation MODEL = ResourceLocation.tryParse(("model/util/model.obj"));
    @Nullable
    public ResourceLocation getTextureLocation(T entity) {
        return entity.getTextureLoc();
    }

    public DemonBladeFragmentsRender(EntityRendererProvider.Context context) {
        super(context);
    }
